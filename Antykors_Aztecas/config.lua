...
Config.Faction = "aztecas" -- set nil to not be locked by a faction // "faction" for locked for a specified faction // {['faction'] = 2} for a specific grade in a faction You can even set {['faction1'] = 3, ['faction2'] = 4} for mutiple factions and grades
...
Config.Blip = {
    ...
    Display = -1, -- defines the display parameter of the blip (0 and 1 doesn't show the blip // 2 is on minimap and map // 4 is only on map // 5 is only on minimap)
    Scale = 0.5, -- defines the scale of the blip (default value when not indicated is 1.0)
    Text = "Quartier Aztecas", -- defines what the blip should be named
}
